...
class ProductController extends Controller
{
    ...
    public function category_create(Request $request)
    {
        ...
        return redirect()->route('products.categories')->with('success-message', 'Product category created successfully.');
    }
    ...
    public function category_update(Request $request)
    {
        ...
        $categoryTitleCount = ProductCategories::where('name', $request->name)->count();
        $categoryTitleInfo = ProductCategories::where('name', $request->name)->first();

        if($categoryTitleCount && ($categoryTitleInfo->id != $request->id)){
            return redirect()->back()->with('error-message', 'Product category already exists !');
        }
